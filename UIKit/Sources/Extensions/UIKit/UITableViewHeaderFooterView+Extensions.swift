...
extension UITableViewHeaderFooterView {
    @IBOutlet
    open var backgroundViewObject: UIView? {
    ...
    @IBOutlet
    public private(set) weak var detailLabelView: UILabel? {
        get {
    ...
    @IBOutlet
    public private(set) weak var indicationView: UIImageView? {
        get {
    ...
    @IBOutlet
    public private(set) weak var switchView: UISwitch? {
        get {
